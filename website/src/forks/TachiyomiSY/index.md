...
title: TachiyomiSY
titleTemplate: false
description: Keeping up-to-date with Tsundoku while also adding exclusive features
...
hero:
  name: TachiyomiSY
  text: Hentai-focused
  tagline: Keeping up-to-date with Tsundoku while also adding exclusive features
