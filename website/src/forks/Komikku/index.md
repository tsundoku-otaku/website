...
title: Komikku
titleTemplate: false
description: A fork with features from Sy and Tsundoku plus added personal flair.
...
hero:
  name: Komikku
  text: Feature-packed
  tagline: A fork with features from Sy and Tsundoku plus added personal flair.
