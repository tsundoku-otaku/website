...
1. **Restart Tsundoku**: Force close and reopen the app.
...
If none of these solutions help, try asking in our [Discord server](https://discord.gg/RycBkEgrPE).
...
## Personalized issue
If you're the only one facing a problem, you might be encountering [Cloudflare](/docs/guides/troubleshooting/#cloudflare) protection, an IP ban, or other countermeasures set by website owners against programs like **Tsundoku**.
...
1. Check [open issues](https://github.com/tsundoku-otaku/tsundoku/issues).
2. Check [closed issues](https://github.com/tsundoku-otaku/tsundoku/issues?q=is%3Aissue+is%3Aclosed) in case it's resolved but not yet released.
