...
Using non-standard **WebView** (like **Firefox**) might cause **Tsundoku** to malfunction or crash.
...
Some sources intentionally have higher **Cloudflare** protection to deter apps like **Tsundoku**.
