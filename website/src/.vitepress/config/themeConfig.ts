...
const themeConfig: DefaultTheme.Config = {
  ...
  socialLinks: [
    {
      icon: 'github',
      link: 'https://github.com/tsundoku-otaku/tsundoku',
      ariaLabel: 'Project GitHub',
    },
    {
      icon: 'discord',
      link: 'https://discord.gg/RycBkEgrPE',
      ariaLabel: 'Discord Server',
    },
    // {
    //   icon: 'x',
    //   link: 'https://x.com/tsundoku-otaku',
    //   ariaLabel: 'X Page',
    // },
    // {
    //   icon: 'facebook',
    //   link: 'https://facebook.com/tsundoku-otaku',
    ...
    //   },
    //   link: 'https://reddit.com/r/tsundoku-otaku',
    //   ariaLabel: 'Support subreddit',
    // },
    // { icon: "instagram", link: "https://instagram.com/tsundoku-otaku", ariaLabel: "Instagram Page" },
  ],
  ...
  editLink: {
    pattern: 'https://github.com/tsundoku-otaku/website/edit/main/website/src/:path',
