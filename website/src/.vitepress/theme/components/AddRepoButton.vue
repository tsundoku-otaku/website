  ...
  <div>
    ...
    <div v-if="isAndroid">
      <div class="action-buttons">
        <a
          class="action-button primary"
          href="tachiyomi://add-repo?url=https://raw.githubusercontent.com/tsundoku-otaku/extensions/repo/index.min.json"
      ...
      <span class="version-disclaimer">
        Requires <strong>Tsundoku 0.15.2</strong> or higher.
      </span>
